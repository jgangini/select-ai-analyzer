...
## Corpus Check
- 258 files · ~113,506 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2322 nodes · 4190 edges · 120 communities (109 shown, 11 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 629 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6c8fb8bb`
...
Cohesion: 0.05
Nodes (63): _capture_runtime_config(), clean_schema(), _drop_current_schema_objects(), _drop_data_schema(), _drop_retired_select_ai_artifacts(), _drop_select_ai_profiles(), _env_runtime_config(), _existing_profiles() (+55 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (41): _assert_csv_table_selectable(), _complete_load_job(), _create_csv_table(), CsvUploadRows, _drop_table_if_exists(), _insert_csv_rows(), _insert_load_job(), _mark_load_job_failed() (+33 more)
...
Cohesion: 0.08
Nodes (20): BootstrapStatusMixin, id, BootstrapStatusMixin, check_setup_status(), clear_status_cache(), Lightweight setup-status reader used by runtime guards., SetupStatusService, from_runtime() (+12 more)
...
Cohesion: 0.07
Nodes (19): _analytics_http_exception(), ask_analytics(), AskAnalyticsRequest, delete_analytics_conversation(), get_analytics_conversation(), get_question_recommendations(), list_analytics_conversations(), rename_analytics_conversation() (+11 more)
...
Cohesion: 0.09
Nodes (24): emptyUserForm, UsersAuthUser, ChangePasswordPayload, CreateUserPayload, LoginResponse, apiMock, UpdateProfilePayload, UserAccount (+16 more)

### Community 14 - "Community 14"
Cohesion: 0.12
Nodes (23): _assert_conversation_writable(), _json_dump(), _materialize_stored_result(), _open_cursor(), _safe_max_rows(), SelectAIConversationMixin, SelectAIConversationMutationMixin, _transaction_cursor() (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (14): _alter_if_missing(), _create_if_missing(), DashboardSchemaMixin, FakeLob, SchemaConnection, SchemaCursor, SchemaDbManager, test_alter_if_missing_ignores_existing_column_or_constraint_errors() (+6 more)

### Community 16 - "Community 16"
Cohesion: 0.13
Nodes (28): AnalyticsVisualizationCard(), AnalyticsVisualizationCardProps, formatCellValue(), getInsertionLineClass(), getMetricLabel(), VisualizationCardItem, buildDropPosition(), buildEdgeDropPosition() (+20 more)
...
Cohesion: 0.09
Nodes (20): DataSourceCatalogTableDetail, EMPTY_DATA_SOURCES, schemaNeedsCreation(), DataSourceListHelpers, DataSourceListState, DataSourceStats, DataSourceSummary, listHelpers (+12 more)
...
Cohesion: 0.1
Nodes (19): DataDictionaryEditor(), DataSourceColumnMetadata, onColumnChange, DataSourceObjectModal(), DataSourceObjectModalProps, DataSourceSchemaCreationConfirmModal(), activeDraft, heading (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (12): BootstrapDatabaseMixin, missing_required_privileges(), DatabaseBootstrapper, DbManager, FakeOracleConnection, FakeOracleCursor, test_db_connection_accepts_app_agent_runtime_privileges(), test_db_connection_rejects_missing_default_data_schema_without_create_user() (+4 more)
...
Cohesion: 0.11
Nodes (20): DashboardItemMoveUpdate, getDashboardItemColumn(), getDashboardItemMoveUpdate(), getVisualizationWidth(), Analytics(), DragSession, ShowToast, AddDashboardItemsPayload (+12 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (20): buildCsvUploadDraft(), buildCsvUploadDrafts(), collectCsvUploadSlots(), CsvUploadSlot, CsvUploadSlotCollection, DataSourceColumnMetadata, DataSourceObjectFormHelpers, DataSourceObjectFormState (+12 more)
...
Cohesion: 0.12
Nodes (20): build_oracle_connection_kwargs(), open_runtime_database_connection(), parse_bootstrap_sql_statements(), read_private_key_for_db_credential(), resolve_oci_cli_config_path(), resolve_runtime_database_config(), write_oci_cli_config_file(), DbManager (+12 more)

### Community 31 - "Community 31"
Cohesion: 0.11
Nodes (20): ShowToast, AnalyticsChatComposer(), AnalyticsChatComposerProps, AnalyticsChatHeader(), AnalyticsChatHeaderProps, AnalyticsChatMessageList(), AnalyticsSuggestedQuestionButtons(), AssistantChatListMessage (+12 more)
...
Cohesion: 0.15
Nodes (15): ChartSpec, infer_chart_spec(), _is_number(), validate_chart_spec(), SelectAIAskMixin, extract_sql_statement(), strip_sql_comments(), validate_read_only_select() (+7 more)
...
Cohesion: 0.15
Nodes (8): SelectAIDataSourcePreviewMixin, CatalogConnection, CatalogCursor, CatalogService, RegisterCursor, test_list_data_sources_returns_json_safe_catalog_rows(), test_list_schemas_includes_default_schema_and_source_counts(), test_sql_name_helpers_reject_blank_identifier()
...
Cohesion: 0.14
Nodes (13): analyticsApiMock, conversation, deleteOverlay, SearchChatsProbe(), searchOverlay, AnalyticsChatContext, AnalyticsChatContextType, AnalyticsChatProvider() (+5 more)
...
Cohesion: 0.2
Nodes (13): build_oci_client_config(), _failure_result(), _generative_model_options(), _inference_test_url(), missing_required_oci_config_keys(), _missing_saved_config_result(), _probe_inference_endpoint(), _read_key_file_content() (+5 more)

### Community 48 - "Community 48"
Cohesion: 0.18
Nodes (10): RuntimeError, BootstrapOciMixin, _oci_file_values(), _upsert_config_items(), normalize_oci_config_rows(), normalize_oci_config_value(), resolve_oci_key_file_path(), ReadableValue (+2 more)

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (18): filterDataSources(), mergeMetadataWithColumns(), parseCsvHeaderLine(), parseCsvHeaders(), sortCatalogTables(), sortSchemaOptions(), summarizeDataSources(), csvInput (+10 more)
...
Cohesion: 0.12
Nodes (15): AgentTraceItem, analyticsApi, AnalyticsAskRequest, AnalyticsAskResponse, AnalyticsConversationDetail, AnalyticsConversationMessage, AnalyticsConversationSummary, analyticsQueryKeys (+7 more)
...
Cohesion: 0.14
Nodes (14): metadataWarningMessage(), cloneCsvUploadDrafts(), CsvUploadMutationVariables, CsvUploadStarter, DataSourceApiForMutations, DataSourceColumnMetadata, DataSourceMutationListState, DataSourceMutations (+6 more)
...
Cohesion: 0.15
Nodes (9): SelectAIDataSourceMixin, SelectAIDataSourceCatalogMixin, SelectAIDataSourceCsvMixin, SelectAIDataSourceMetadataMixin, SelectAIDataSourcePreviewMixin, SelectAIDataSourceSchemaMixin, PreviewConnection, PreviewService (+1 more)
...
Cohesion: 0.14
Nodes (8): apiClient, draft, form, invalidateSources, onCsvUploadSettled, { result }, showToast, uploadResult

### Community 68 - "Community 68"
Cohesion: 0.24
Nodes (12): AdminPasswordRequest, DBRuntimeConfigRequest, DBTestRequest, GenerativeAIConfigRequest, ObjectStorageTestRequest, OCIConfigRequest, SetupRequest, WalletDSNRequest (+4 more)
...
Cohesion: 0.17
Nodes (8): DashboardItemMutationMixin, DashboardMutationMixin, DashboardQueryMixin, DashboardSchemaMixin, DashboardCreateRequest, DashboardItemRequest, DashboardItemsCreateRequest, DashboardService
...
Cohesion: 0.27
Nodes (7): Home(), buildHomeStatCards(), formatNumber(), HomeStatCard, HomeStatsSource, StatKind, cards
...
Cohesion: 0.2
Nodes (6): SelectAIAnalyticsService, SelectAIBaseService, SelectAIConversationMixin, SelectAIGenerationMixin, SelectAIScopedProfileMixin, ScopedProfileService
...
Cohesion: 0.22
Nodes (7): LoadingState(), LoadingStateProps, SIZE_STYLES, Profile(), ProfileFormData, currentUser, usersApiMock
...
Cohesion: 0.29
Nodes (5): BaseDbManager, FakeLob, test_profile_name_reads_config_value_and_lobs(), test_profile_name_uses_default_when_config_table_is_missing(), test_refresh_profile_calls_profile_procedure()

### Community 88 - "Community 88"
Cohesion: 0.2
Nodes (6): api, csvFile, jsonFile, { result }, sources, uploadResult
...
Cohesion: 0.25
Nodes (7): CardProps, item, onCardMouseDown, onDelete, onRename, onToggleMenu, onViewSql
...
Cohesion: 0.5
Nodes (3): createClientId(), getRandomValues, randomUUID
...
## Knowledge Gaps
- **465 isolated node(s):** `Top-level package marker for Docker runtime imports.`, `FastAPI entrypoint for Select AI Analytics.`, `Block runtime operations until the setup wizard has completed.`, `When `_env_file=None` is explicit, force defaults/init values only.`, `Persist DB connection chosen in setup wizard.` (+460 more)
...
- **Why does `id` connect `Community 9` to `Community 8`, `Community 102`?**
  _High betweenness centrality (0.438) - this node is a cross-community bridge._
- **Why does `DatabaseManager` connect `Community 33` to `Community 65`, `Community 71`, `Community 8`, `Community 9`, `Community 7`, `Community 10`, `Community 87`, `Community 60`?**
  _High betweenness centrality (0.328) - this node is a cross-community bridge._
- **Why does `BootstrapStatusMixin` connect `Community 9` to `Community 33`, `Community 85`?**
