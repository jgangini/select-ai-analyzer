...
## Corpus Check
- 255 files · ~113,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2272 nodes · 4133 edges · 127 communities (113 shown, 14 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 630 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65113727`
...
Cohesion: 0.07
Nodes (49): main(), build_create_table_sql(), _normalize_identifier(), oracle_type_for_ddl(), parse_source_tables(), Parse SQL*Plus DESC output from .source into table metadata.      Blocks with SQ, SourceColumn, SourceTable (+41 more)
...
Cohesion: 0.05
Nodes (17): _cursor(), SelectAIBaseService, SelectAIBaseService, _created_profile_attributes(), FakeLob, ScopedProfileConnection, ScopedProfileCursor, ScopedProfileService (+9 more)
...
Cohesion: 0.08
Nodes (16): Block runtime operations until the setup wizard has completed., require_setup_completed(), get_db_manager(), Helpers de sesion/conexion para FastAPI., Retorna singleton de DatabaseManager., ConfigService, _is_missing_config_table_error(), _normalize_value() (+8 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (31): DataSourcePreviewModal(), DataSourcePreviewModalProps, onClose, onPageChange, PreviewProps, { rerender }, response, source (+23 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (24): DataDictionaryEditor(), DataSourceColumnMetadata, onColumnChange, onTableCommentChange, DataSourceObjectModal(), DataSourceObjectModalProps, activeDraft, csvField (+16 more)
...
Cohesion: 0.09
Nodes (27): DataSourceCatalogTableDetail, dataSourceStatusBadgeClassNames, EMPTY_DATA_SOURCES, filterDataSources(), mergeMetadataWithColumns(), metadataText(), ObjectSubmitState, PaginationWindow (+19 more)

### Community 17 - "Community 17"
Cohesion: 0.15
Nodes (21): ShowToast, compactQuestions(), DEFAULT_SUGGESTED_QUESTIONS, normalizeSuggestedQuestionRecord(), normalizeSuggestedQuestions(), replaceSuggestedQuestionAt(), resolveSuggestedQuestions(), selectInitialSuggestedQuestions() (+13 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (21): DataSourceListHelpers, DataSourceListState, DataSourceStats, DataSourceSummary, listHelpers, { rerender, result }, { result }, Source (+13 more)
...
Cohesion: 0.11
Nodes (9): ensure_conversation(), SelectAIConversationMixin, ConversationService, RecordingConnection, RecordingCursor, test_ensure_conversation_rejects_unknown_type(), test_record_question_run_commits_conversation_before_insert(), test_record_question_run_rejects_other_users_conversation() (+1 more)
...
Cohesion: 0.13
Nodes (12): _alter_if_missing(), _create_if_missing(), DashboardSchemaMixin, _normalize_visibility(), FakeLob, SchemaCursor, test_alter_if_missing_ignores_existing_column_or_constraint_errors(), test_create_if_missing_ignores_existing_object_error() (+4 more)
...
Cohesion: 0.12
Nodes (17): ChartPreview(), DashboardItemMoveUpdate, DragSession, ShowToast, AddDashboardItemsPayload, ChartSpec, CreateDashboardPayload, DashboardDetail (+9 more)
...
Cohesion: 0.16
Nodes (15): _assert_conversation_writable(), _json_dump(), SelectAIConversationMutationMixin, _analytics_conversation_exists(), _delete_analytics_conversation(), _delete_question_runs(), _insert_question_run(), _insert_question_run_snapshot() (+7 more)

### Community 37 - "Community 37"
Cohesion: 0.18
Nodes (15): analyticsApi, checkSetupComplete(), readAppSetting(), resolveAgentName(), resolveApplicationName(), resolveSuggestedQuestions(), settingsQueryKeys, setupQueryKeys (+7 more)
...
Cohesion: 0.14
Nodes (13): analyticsApiMock, conversation, deleteOverlay, OpenSearchButton(), SearchChatsProbe(), searchOverlay, AnalyticsChatContext, AnalyticsChatContextType (+5 more)

### Community 42 - "Community 42"
Cohesion: 0.15
Nodes (15): build_oracle_connection_kwargs(), open_runtime_database_connection(), parse_bootstrap_sql_statements(), read_private_key_for_db_credential(), resolve_runtime_database_config(), DbManager, Settings, test_bootstrap_sql_files_are_grouped_by_domain() (+7 more)

### Community 43 - "Community 43"
Cohesion: 0.12
Nodes (8): DashboardItemMutationMixin, DashboardMutationMixin, DashboardQueryMixin, DashboardSchemaMixin, DashboardService, SchemaConnection, SchemaDbManager, test_ensure_tables_creates_dashboard_schema_and_commits()
...
Cohesion: 0.16
Nodes (15): AnalyticsDashboardHeader(), AnalyticsDashboardTabs(), DashboardHeaderBase, DashboardTabSummary, onDelete, onRename, onSelect, onVisibilityChange (+7 more)

### Community 46 - "Community 46"
Cohesion: 0.14
Nodes (15): normalizeIdentifier(), buildCsvUploadDraft(), buildCsvUploadDrafts(), collectCsvUploadSlots(), CsvUploadSlot, CsvUploadSlotCollection, DataSourceColumnMetadata, DataSourceObjectFormHelpers (+7 more)

### Community 47 - "Community 47"
Cohesion: 0.2
Nodes (12): _materialize_stored_result(), _open_cursor(), _safe_max_rows(), SelectAIConversationMixin, _transaction_cursor(), _select_conversation_list(), _select_user_question_usage(), _json_loads() (+4 more)

### Community 48 - "Community 48"
Cohesion: 0.12
Nodes (15): DataSourceCatalogOwner, DataSourceCatalogTable, DataSourceCatalogTableDetail, DataSourceColumnMetadata, DataSourceMutationResponse, DataSourceRowsResponse, dataSourcesApi, DataSourceSchema (+7 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (14): AgentTraceItem, AnalyticsAskRequest, AnalyticsAskResponse, AnalyticsConversationDetail, AnalyticsConversationMessage, AnalyticsConversationSummary, analyticsQueryKeys, AnalyticsQuestionRecommendation (+6 more)
...
Cohesion: 0.19
Nodes (11): getLoginErrorMessage(), LoginForm(), makeMonochromeOracleSvg(), oracleServices, reviewSignals, login, AppBrand(), AppBrandProps (+3 more)
...
Cohesion: 0.17
Nodes (15): build_oci_client_config(), _generative_model_options(), _inference_test_url(), missing_required_oci_config_keys(), _probe_inference_endpoint(), resolve_backend_root(), resolve_bootstrap_sql_dir(), resolve_oci_cli_config_path() (+7 more)

### Community 54 - "Community 54"
Cohesion: 0.18
Nodes (15): AdminPasswordRequest, DBRuntimeConfigRequest, DBTestRequest, GenerativeAIConfigRequest, ObjectStorageTestRequest, OCIConfigRequest, SetupRequest, WalletDSNRequest (+7 more)
...
Cohesion: 0.18
Nodes (8): RuntimeError, _oci_file_values(), _upsert_config_items(), normalize_oci_config_rows(), normalize_oci_config_value(), ReadableValue, test_normalize_oci_config_rows_strips_prefix_and_reads_values(), test_normalize_oci_config_value_reads_lobs_and_trims()
...
Cohesion: 0.14
Nodes (12): AssistantAnalyticsResult, AssistantChartSpec, AssistantResult(), DashboardDraftItem, ConfirmDeleteModal(), ConfirmDeleteModalProps, ConfirmModal(), ConfirmModalProps (+4 more)
...
Cohesion: 0.25
Nodes (9): Home(), buildHomeStatCards(), buildReadinessSummary(), formatNumber(), HomeStatCard, HomeStatsSource, StatKind, cards (+1 more)

### Community 64 - "Community 64"
Cohesion: 0.22
Nodes (6): DatabaseManager, Initialize connection pool (thin mode, no Oracle Client)., Get connection from pool., Close pool (on shutdown)., Return whether a table exists in the current schema., Singleton to manage connection pool to Autonomous Database.
...
Cohesion: 0.27
Nodes (10): _analytics_http_exception(), ask_analytics(), AskAnalyticsRequest, delete_analytics_conversation(), get_analytics_conversation(), get_question_recommendations(), list_analytics_conversations(), rename_analytics_conversation() (+2 more)

### Community 70 - "Community 70"
Cohesion: 0.36
Nodes (5): BootstrapOciMixin, _failure_result(), _missing_saved_config_result(), _read_key_file_content(), _success_result()
...
Cohesion: 0.17
Nodes (11): AnalyticsChatHeader(), AnalyticsSuggestedQuestionButtons(), composer, onChange, onDeleteRequest, onRefreshQuestion, onRenameDraftChange, onSelect (+3 more)
...
Cohesion: 0.18
Nodes (10): DataSourceCsvUploadDraft, metadataWarningMessage(), DataSourceApiForMutations, DataSourceColumnMetadata, DataSourceMutationListState, DataSourceMutations, DataSourceObjectFormForMutations, DataSourceSummary (+2 more)
...
Cohesion: 0.22
Nodes (3): Raised when the configured model provider reports temporary capacity exhaustion., SelectAIModelCapacityError, CapacityFallbackAskService
...
Cohesion: 0.33
Nodes (8): ChartSpec, infer_chart_spec(), _is_number(), validate_chart_spec(), test_default_suggested_questions_have_chartable_results(), test_infer_chart_spec_prefers_bar_for_category_and_number(), test_infer_chart_spec_uses_bar_for_single_row_numeric_comparison(), test_validate_chart_spec_rejects_unknown_columns()

### Community 81 - "Community 81"
Cohesion: 0.22
Nodes (6): _missing_required_config(), get_oci_bucket_name(), get_oci_namespace(), Read OCI-related configuration from config table., Get OCI namespace from config table., Get single Object Storage bucket name from config table.

### Community 82 - "Community 82"
Cohesion: 0.31
Nodes (6): auth_service_with_config(), StubConfigService, test_resolve_session_timeout_caches_configured_value(), test_resolve_session_timeout_enforces_minimum_one_minute(), test_resolve_session_timeout_falls_back_to_settings_on_invalid_config(), test_resolve_session_timeout_uses_configured_value()
...
Cohesion: 0.22
Nodes (8): AnalyticsChatComposer(), AnalyticsChatComposerProps, AnalyticsChatHeaderProps, AnalyticsChatMessageList(), AssistantChatListMessage, ChatListMessage, ChatMessageBubble(), formatTime()

### Community 86 - "Community 86"
Cohesion: 0.2
Nodes (8): AddDashboardStep, AnalyticsAddVisualizationModal(), AnalyticsDashboardTray(), AnalyticsDeleteChatModal(), DashboardChartSpec, DashboardDraftItem, DashboardSummary, DashboardTargetMode
...
Cohesion: 0.33
Nodes (5): DatabaseBootstrapper, DbManager, test_list_wallet_dsns_reports_missing_tnsnames(), test_list_wallet_dsns_returns_aliases_and_prefers_medium(), test_save_runtime_db_config_delegates_to_db_manager()
...
Cohesion: 0.29
Nodes (5): create_access_token(), Verify password against bcrypt hash., verify_password(), authenticate_user(), login()

### Community 92 - "Community 92"
Cohesion: 0.46
Nodes (7): resolve_csv_metadata(), _boolish(), normalize_identifier(), parse_metadata_payload(), _pick(), _picked_text(), _text()

### Community 93 - "Community 93"
Cohesion: 0.25
Nodes (6): csvFile, file, formHelpers, jsonFile, { result }, showToast

### Community 94 - "Community 94"
Cohesion: 0.29
Nodes (6): test_ask_uses_deterministic_sql_when_model_capacity_is_exhausted(), test_customer_growth_question_has_deterministic_fallback_sql(), test_customer_volume_question_has_deterministic_fallback_sql(), test_default_suggested_questions_have_deterministic_fallback_sql(), test_starter_suggested_questions_have_chartable_results(), test_starter_suggested_questions_have_deterministic_fallback_sql()

### Community 96 - "Community 96"
Cohesion: 0.38
Nodes (6): decode_access_token(), get_current_user(), get_settings(), Inject settings from main.py., Dependency to get current user from JWT token., set_settings()
...
Cohesion: 0.33
Nodes (5): RenameAnalyticsConversationRequest, SelectAIAnalyticsService, SelectAIAskMixin, SelectAIGenerationMixin, SelectAIScopedProfileMixin

### Community 99 - "Community 99"
Cohesion: 0.4
Nodes (4): BaseSettings, get_settings(), When `_env_file=None` is explicit, force defaults/init values only., Settings

### Community 100 - "Community 100"
Cohesion: 0.47
Nodes (4): get_auth_service(), get_current_user_info(), login(), LoginRequest
...
## Knowledge Gaps
- **454 isolated node(s):** `Top-level package marker for Docker runtime imports.`, `FastAPI entrypoint for Select AI Analytics.`, `Block runtime operations until the setup wizard has completed.`, `When `_env_file=None` is explicit, force defaults/init values only.`, `Persist DB connection chosen in setup wizard.` (+449 more)
...
- **Why does `DatabaseManager` connect `Community 64` to `Community 101`, `Community 6`, `Community 7`, `Community 9`, `Community 43`, `Community 11`, `Community 12`, `Community 81`, `Community 57`, `Community 95`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 7` to `Community 64`, `Community 1`, `Community 98`, `Community 3`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `DashboardService` connect `Community 43` to `Community 64`, `Community 78`, `Community 54`, `Community 22`, `Community 25`, `Community 90`, `Community 31`?**
