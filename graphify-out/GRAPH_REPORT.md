...
## Corpus Check
- 255 files · ~111,819 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2254 nodes · 4104 edges · 111 communities (103 shown, 8 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 630 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4af53975`
...
Cohesion: 0.05
Nodes (45): getLoginErrorMessage(), LoginForm(), makeMonochromeOracleSvg(), oracleServices, reviewSignals, login, DraftConversationPreview, Analytics (+37 more)
...
Cohesion: 0.05
Nodes (39): Home(), buildHomeStatCards(), buildReadinessSummary(), formatNumber(), HomeStatCard, HomeStatsSource, StatKind, cards (+31 more)
...
Cohesion: 0.1
Nodes (13): _data_source_from_cursor(), SelectAIDataSourcePreviewMixin, _source_column_details(), CatalogConnection, CatalogCursor, CatalogService, FakeLob, RegisterConnection (+5 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (24): DataDictionaryEditor(), DataSourceColumnMetadata, onColumnChange, onTableCommentChange, DataSourceObjectModal(), DataSourceObjectModalProps, csvField, csvFieldWrapper (+16 more)
...
Cohesion: 0.14
Nodes (19): _execute_metadata_statement(), _metadata_annotation_clause(), _metadata_by_column(), _primary_key_exists(), _replace_source_columns(), SelectAIDataSourceMetadataMixin, _assert_data_schema(), _grant_if_permitted() (+11 more)

### Community 21 - "Community 21"
Cohesion: 0.1
Nodes (24): ChartPreview(), AnalyticsChatPanel(), ShowToast, AnalyticsChatComposer(), AnalyticsChatComposerProps, AnalyticsChatHeader(), AnalyticsChatHeaderProps, AnalyticsChatMessageList() (+16 more)
...
Cohesion: 0.15
Nodes (21): ConfirmQuestionModal(), compactQuestions(), DEFAULT_SUGGESTED_QUESTIONS, normalizeSuggestedQuestionRecord(), normalizeSuggestedQuestions(), replaceSuggestedQuestionAt(), resolveSuggestedQuestions(), selectInitialSuggestedQuestions() (+13 more)
...
Cohesion: 0.13
Nodes (19): build_oracle_connection_kwargs(), open_runtime_database_connection(), parse_bootstrap_sql_statements(), read_private_key_for_db_credential(), resolve_oci_cli_config_path(), summarize_oracle_connect_error(), write_oci_cli_config_file(), DbManager (+11 more)
...
Cohesion: 0.11
Nodes (10): SelectAIDataSourceMixin, SelectAIDataSourceCatalogMixin, SelectAIDataSourceCsvMixin, SelectAIDataSourceMetadataMixin, SelectAIDataSourcePreviewMixin, SelectAIDataSourceSchemaMixin, PreviewConnection, PreviewCursor (+2 more)
...
Cohesion: 0.15
Nodes (12): analyticsApiMock, conversation, deleteOverlay, OpenSearchButton(), SearchChatsProbe(), searchOverlay, AnalyticsChatContext, AnalyticsChatContextType (+4 more)

### Community 50 - "Community 50"
Cohesion: 0.13
Nodes (10): AnalyticsDashboardSurface(), { rerender }, SurfaceProps, LoadingState(), LoadingStateProps, SIZE_STYLES, Profile(), ProfileFormData (+2 more)
...
Cohesion: 0.21
Nodes (13): checkSetupComplete(), readAppSetting(), resolveAgentName(), resolveApplicationName(), resolveSuggestedQuestions(), settingsQueryKeys, setupQueryKeys, payload (+5 more)
...
Cohesion: 0.2
Nodes (11): DashboardQueryMixin, _json_loads(), _materialize_stored_result(), _safe_max_rows(), _select_dashboard(), _select_dashboard_items(), _select_dashboards(), _json_loads() (+3 more)
...
Cohesion: 0.26
Nodes (9): _select_user_question_usage(), build_question_recommendations(), compact_questions(), normalize_question_text(), _read_usage_value(), test_question_usage_counts_only_successful_data_results(), test_build_question_recommendations_prioritizes_unused_for_new_chat_and_usage_for_home(), test_compact_questions_removes_blank_and_duplicate_questions() (+1 more)
...
Cohesion: 0.2
Nodes (4): FakeConnection, FakeCursor, test_execute_read_only_select_rejects_mutating_sql_before_opening_connection(), test_execute_read_only_select_validates_and_serializes_rows()
...
Cohesion: 0.38
Nodes (3): execute_read_only_select(), _capacity_fallback_answer(), SelectAIAskMixin
...
Cohesion: 0.33
Nodes (5): RenameAnalyticsConversationRequest, SelectAIAnalyticsService, SelectAIAskMixin, SelectAIBaseService, SelectAIGenerationMixin
...
- **Why does `DatabaseManager` connect `Community 33` to `Community 64`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 27`, `Community 63`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 8` to `Community 33`, `Community 42`, `Community 90`, `Community 37`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `DashboardService` connect `Community 27` to `Community 33`, `Community 41`, `Community 13`, `Community 82`, `Community 58`, `Community 28`?**
