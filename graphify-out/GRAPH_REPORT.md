...
## Corpus Check
- 249 files · ~107,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2178 nodes · 3946 edges · 124 communities (109 shown, 15 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 610 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f8fd869`
...
Cohesion: 0.06
Nodes (56): DashboardItemMutationMixin, _dashboard_item_insert_params(), _dashboard_item_update_fields(), _json_object_literal(), _normalize_dashboard_item_ids(), _normalize_dashboard_items(), _normalize_required_text(), _dashboard_exists_for_owner() (+48 more)
...
Cohesion: 0.07
Nodes (30): _assert_conversation_writable(), _json_dump(), _materialize_stored_result(), _open_cursor(), _safe_max_rows(), SelectAIConversationMixin, SelectAIConversationMutationMixin, _transaction_cursor() (+22 more)
...
Cohesion: 0.08
Nodes (35): DataSourceCatalogOwner, DataSourceCatalogTable, DataSourceCatalogTableDetail, DataSourceSchema, dataSourceStatusBadgeClassNames, EMPTY_DATA_SOURCES, filterDataSources(), mergeMetadataWithColumns() (+27 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (22): ChartSpec, infer_chart_spec(), _is_number(), validate_chart_spec(), execute_read_only_select(), _capacity_fallback_answer(), SelectAIAskMixin, extract_sql_statement() (+14 more)
...
Cohesion: 0.13
Nodes (18): LoadingState(), LoadingStateProps, SIZE_STYLES, DataSourcePreviewModal(), DataSourcePreviewModalProps, DataSourcesTable(), DataSourcesTableProps, Pagination() (+10 more)
...
Cohesion: 0.14
Nodes (9): CatalogConnection, CatalogCursor, CatalogService, RegisterCursor, test_create_data_schema_allows_dev_runtime_without_grant_any_privilege(), test_list_data_sources_returns_json_safe_catalog_rows(), test_list_schemas_includes_default_schema_and_source_counts(), test_register_existing_table_rolls_back_when_source_column_sync_fails() (+1 more)
...
Cohesion: 0.12
Nodes (16): AnalyticsChatComposer(), AnalyticsChatComposerProps, AnalyticsChatHeader(), AnalyticsChatHeaderProps, AssistantChatListMessage, ChatListMessage, ChatMessageBubble(), formatTime() (+8 more)
...
Cohesion: 0.16
Nodes (12): DataDictionaryEditor(), DataSourceColumnMetadata, onColumnChange, onTableCommentChange, DataSourceObjectModal(), DataSourceObjectModalProps, ModalProps, onObjectModeChange (+4 more)
...
Cohesion: 0.14
Nodes (11): DataSourceDeleteConfirmModal(), DataSourceSchemaCreationConfirmModal(), DataSourceStats, useDataSourceMutations(), buildDataSourcesController(), useDataSourceQueries(), useDataSourcesController(), DataSources() (+3 more)
...
Cohesion: 0.16
Nodes (6): Raised when the configured model provider reports temporary capacity exhaustion., SelectAIModelCapacityError, CapacityFallbackAskService, test_ask_uses_deterministic_sql_when_model_capacity_is_exhausted(), test_customer_growth_question_has_deterministic_fallback_sql(), test_default_suggested_questions_have_deterministic_fallback_sql()
...
Cohesion: 0.21
Nodes (8): _data_source_from_cursor(), SelectAIDataSourcePreviewMixin, _source_column_details(), _json_loads(), _json_safe(), _read_lob(), FakeLob, test_json_safe_reads_lobs_and_serializes_runtime_values()
...
Cohesion: 0.18
Nodes (11): AddDashboardStep, AnalyticsAddVisualizationModal(), AnalyticsDashboardTray(), AnalyticsDeleteChatModal(), DashboardChartSpec, DashboardDraftItem, DashboardSummary, DashboardTargetMode (+3 more)
...
Cohesion: 0.15
Nodes (10): AssistantAnalyticsResult, AssistantChartSpec, AssistantResult(), DashboardDraftItem, ConfirmDeleteModalProps, ConfirmModal(), ConfirmModalProps, ConfirmQuestionModal() (+2 more)
...
Cohesion: 0.2
Nodes (3): PreviewConnection, PreviewCursor, test_preview_data_source_rows_serializes_rows_and_clamps_pagination()

### Community 84 - "Community 84"
Cohesion: 0.2
Nodes (6): DashboardItemMutationMixin, DashboardMutationMixin, DashboardQueryMixin, DashboardSchemaMixin, DashboardItemUpdateRequest, DashboardService
...
## Knowledge Gaps
- **428 isolated node(s):** `Top-level package marker for Docker runtime imports.`, `FastAPI entrypoint for Select AI Analytics.`, `Block runtime operations until the setup wizard has completed.`, `When `_env_file=None` is explicit, force defaults/init values only.`, `Persist DB connection chosen in setup wizard.` (+423 more)
...
- **Why does `DatabaseManager` connect `Community 20` to `Community 96`, `Community 4`, `Community 8`, `Community 10`, `Community 82`, `Community 84`, `Community 54`, `Community 60`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 82` to `Community 69`, `Community 42`, `Community 13`, `Community 78`, `Community 51`, `Community 20`, `Community 95`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `SelectAIDataSourceMixin` connect `Community 78` to `Community 65`, `Community 1`, `Community 70`, `Community 103`, `Community 13`, `Community 82`, `Community 83`, `Community 26`, `Community 61`?**
