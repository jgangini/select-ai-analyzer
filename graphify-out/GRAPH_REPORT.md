...
## Corpus Check
- 255 files · ~111,627 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2242 nodes · 4082 edges · 120 communities (107 shown, 13 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 625 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9bfe051e`
...
8. `_fallback_sql_for_question()` - 22 edges
...
Cohesion: 0.07
Nodes (35): DashboardItemMutationMixin, _dashboard_item_insert_params(), _dashboard_item_update_fields(), _json_object_literal(), _normalize_dashboard_item_ids(), _normalize_dashboard_items(), _normalize_required_text(), _dashboard_exists_for_owner() (+27 more)
...
Cohesion: 0.08
Nodes (19): BootstrapStatusMixin, BootstrapStatusMixin, check_setup_status(), clear_status_cache(), Lightweight setup-status reader used by runtime guards., SetupStatusService, from_runtime(), DbManager (+11 more)
...
Cohesion: 0.1
Nodes (25): DataSourcePreviewModal(), DataSourcePreviewModalProps, DataSourcesTable(), DataSourcesTableProps, Pagination(), buildPreviewColumnDetails(), DataSourceCatalogTableDetail, DataSourceColumnMetadata (+17 more)
...
Cohesion: 0.11
Nodes (21): ChartPreview(), DashboardItemMoveUpdate, getDashboardItemColumn(), getDashboardItemMoveUpdate(), getVisualizationWidth(), Analytics(), DragSession, ShowToast (+13 more)

### Community 20 - "Community 20"
Cohesion: 0.12
Nodes (20): build_oracle_connection_kwargs(), open_runtime_database_connection(), parse_bootstrap_sql_statements(), resolve_oci_cli_config_path(), resolve_runtime_database_config(), summarize_oracle_connect_error(), write_oci_cli_config_file(), DbManager (+12 more)
...
Cohesion: 0.13
Nodes (14): analyticsApiMock, conversation, deleteOverlay, OpenSearchButton(), SearchChatsProbe(), searchOverlay, AnalyticsChatContext, AnalyticsChatContextType (+6 more)
...
Cohesion: 0.16
Nodes (7): CatalogConnection, CatalogCursor, CatalogService, test_create_data_schema_allows_dev_runtime_without_grant_any_privilege(), test_list_data_sources_returns_json_safe_catalog_rows(), test_list_schemas_includes_default_schema_and_source_counts(), test_sql_name_helpers_reject_blank_identifier()
...
Cohesion: 0.16
Nodes (6): _created_profile_attributes(), FakeLob, ScopedProfileConnection, ScopedProfileService, test_create_scoped_profile_rejects_missing_genai_model(), test_create_scoped_profile_uses_configured_genai_model()
...
Cohesion: 0.19
Nodes (13): ChartSpec, infer_chart_spec(), _is_number(), validate_chart_spec(), test_ask_uses_deterministic_sql_when_model_capacity_is_exhausted(), test_customer_growth_question_has_deterministic_fallback_sql(), test_default_suggested_questions_have_chartable_results(), test_default_suggested_questions_have_deterministic_fallback_sql() (+5 more)
...
Cohesion: 0.13
Nodes (13): AgentTraceItem, AnalyticsAskRequest, AnalyticsAskResponse, AnalyticsConversationDetail, AnalyticsConversationMessage, AnalyticsConversationSummary, AnalyticsQuestionRecommendation, AnalyticsQuestionRecommendations (+5 more)

### Community 57 - "Community 57"
Cohesion: 0.21
Nodes (11): Home(), buildHomeStatCards(), buildReadinessSummary(), formatNumber(), HomeStatCard, HomeStatsSource, StatKind, cards (+3 more)

### Community 58 - "Community 58"
Cohesion: 0.13
Nodes (14): DataSourceCatalogOwner, DataSourceCatalogTable, DataSourceCatalogTableDetail, DataSourceColumnMetadata, DataSourceMutationResponse, DataSourceRowsResponse, dataSourcesApi, DataSourceSchema (+6 more)
...
Cohesion: 0.15
Nodes (10): DataSourceColumnMetadata, DataSourceObjectFormHelpers, DataSourceObjectFormState, DataSourceObjectMode, ParsedMetadata, ShowToast, file, formHelpers (+2 more)
...
Cohesion: 0.2
Nodes (7): _oci_file_values(), _upsert_config_items(), normalize_oci_config_rows(), normalize_oci_config_value(), read_private_key_for_db_credential(), test_read_private_key_for_db_credential_rejects_empty_key(), test_read_private_key_for_db_credential_strips_pem_markers()
...
Cohesion: 0.27
Nodes (6): AppBrand(), AppBrandProps, Footer(), Header(), HeaderProps, LayoutProps
...
Cohesion: 0.33
Nodes (5): SelectAIAnalyticsService, SelectAIAskMixin, SelectAIBaseService, SelectAIGenerationMixin, SelectAIScopedProfileMixin
...
- **Why does `DatabaseManager` connect `Community 67` to `Community 3`, `Community 7`, `Community 10`, `Community 11`, `Community 81`, `Community 21`, `Community 86`, `Community 60`, `Community 93`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 86` to `Community 0`, `Community 97`, `Community 98`, `Community 99`, `Community 67`, `Community 50`, `Community 52`, `Community 53`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `SelectAIDataSourceMixin` connect `Community 52` to `Community 0`, `Community 68`, `Community 73`, `Community 44`, `Community 83`, `Community 84`, `Community 86`, `Community 92`?**
