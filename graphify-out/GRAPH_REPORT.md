...
## Corpus Check
- 248 files · ~106,773 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2169 nodes · 3925 edges · 110 communities (101 shown, 9 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 606 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fffede5c`
...
Cohesion: 0.05
Nodes (27): SelectAIDataSourceMixin, SelectAIDataSourcePreviewMixin, SelectAIDataSourceCatalogMixin, SelectAIDataSourceCsvMixin, SelectAIDataSourceMetadataMixin, SelectAIDataSourceMixin, SelectAIDataSourcePreviewMixin, SelectAIDataSourceSchemaMixin (+19 more)
...
Cohesion: 0.05
Nodes (26): Block runtime operations until the setup wizard has completed., require_setup_completed(), DatabaseManager, _missing_required_config(), Initialize connection pool (thin mode, no Oracle Client)., Get connection from pool., Close pool (on shutdown)., Return whether a table exists in the current schema. (+18 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (22): Protocol, AvatarFile, AvatarStorage, AvatarValidationError, media_type(), _default_payload(), _default_suggested_questions_payload(), _entry_from_setting() (+14 more)
...
Cohesion: 0.08
Nodes (37): AnalyticsChatPanel(), AnalyticsChatMessage, AnalyticsChatResult, AnalyticsConversationForMessages, buildConversationMessages(), buildDashboardDraftItem(), findLatestAssistantMessage(), findLatestMessage() (+29 more)

### Community 12 - "Community 12"
Cohesion: 0.1
Nodes (16): BootstrapStatusMixin, check_setup_status(), Lightweight setup-status reader used by runtime guards., SetupStatusService, DbManager, FakeConnection, FakeCursor, FakeStatusReader (+8 more)
...
Cohesion: 0.13
Nodes (22): _assert_conversation_writable(), _json_dump(), _materialize_stored_result(), _open_cursor(), _safe_max_rows(), SelectAIConversationMixin, SelectAIConversationMutationMixin, _transaction_cursor() (+14 more)

### Community 16 - "Community 16"
Cohesion: 0.1
Nodes (24): AnalyticsChatComposerProps, AnalyticsChatHeader(), AnalyticsChatHeaderProps, AnalyticsChatMessageList(), AssistantChatListMessage, ChatListMessage, ChatMessageBubble(), formatTime() (+16 more)
...
Cohesion: 0.13
Nodes (12): DbManager, FakeBootstrapOciService, FakeConnection, FakeCursor, Settings, test_complete_setup_marks_wizard_done_and_regenerates_runtime_config(), test_generative_ai_validation_normalizes_url_and_allows_http_status_errors(), test_generative_ai_validation_reports_unreachable_endpoint() (+4 more)
...
Cohesion: 0.12
Nodes (20): DataSourceObjectModal(), DataSourceObjectModalProps, ModalProps, onObjectModeChange, catalogTablePlaceholder(), DataSourceCatalogOwner, DataSourceCatalogTable, DataSourceObjectMode (+12 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (22): ChartPreview(), AddDashboardStep, AnalyticsAddVisualizationModal(), AnalyticsDashboardTray(), AnalyticsDeleteChatModal(), DashboardChartSpec, DashboardDraftItem, DashboardSummary (+14 more)
...
Cohesion: 0.14
Nodes (19): build_oci_client_config(), build_oracle_connection_kwargs(), _failure_result(), _generative_model_options(), _inference_test_url(), missing_required_oci_config_keys(), _missing_saved_config_result(), open_runtime_database_connection() (+11 more)
...
Cohesion: 0.11
Nodes (9): DashboardItemMutationMixin, DashboardMutationMixin, DashboardQueryMixin, DashboardSchemaMixin, DashboardItemRequest, DashboardService, SchemaConnection, SchemaDbManager (+1 more)
...
Cohesion: 0.17
Nodes (14): parse_bootstrap_sql_statements(), read_private_key_for_db_credential(), resolve_oci_cli_config_path(), write_oci_cli_config_file(), DbManager, Settings, test_bootstrap_sql_files_are_grouped_by_domain(), test_open_runtime_database_connection_reports_missing_config() (+6 more)
...
Cohesion: 0.12
Nodes (15): filterDataSources(), mergeMetadataWithColumns(), schemaNeedsCreation(), summarizeDataSources(), csvInput, csvReady, details, filtered (+7 more)
...
Cohesion: 0.22
Nodes (7): BootstrapDatabaseMixin, BootstrapDatabaseMixin, DatabaseBootstrapper, DbManager, test_list_wallet_dsns_reports_missing_tnsnames(), test_list_wallet_dsns_returns_aliases_and_prefers_medium(), test_save_runtime_db_config_delegates_to_db_manager()

### Community 67 - "Community 67"
Cohesion: 0.18
Nodes (9): BootstrapOciMixin, BootstrapScriptMixin, BootstrapStatusMixin, get_password_hash(), Generate bcrypt hash of password (72-byte limit)., RuntimeError, create_admin_user(), Initial setup service (database, OCI, admin user). (+1 more)
...
Cohesion: 0.18
Nodes (10): AnalyticsChatComposer(), AnalyticsSuggestedQuestionButtons(), composer, onChange, onRefreshQuestion, onRenameDraftChange, onSelect, onStartRename (+2 more)
...
Cohesion: 0.36
Nodes (6): AnalyticsChatContext, AnalyticsChatContextType, AnalyticsChatProvider(), AnalyticsChatProbe(), useAnalyticsChat(), Layout()
...
- **Why does `DatabaseManager` connect `Community 6` to `Community 64`, `Community 7`, `Community 72`, `Community 9`, `Community 44`, `Community 12`, `Community 82`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 82` to `Community 0`, `Community 32`, `Community 4`, `Community 69`, `Community 6`, `Community 49`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `SelectAIDataSourceMixin` connect `Community 4` to `Community 0`, `Community 82`, `Community 42`?**
