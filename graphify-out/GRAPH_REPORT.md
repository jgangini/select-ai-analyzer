...
## Corpus Check
- 255 files · ~111,921 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2254 nodes · 4104 edges · 122 communities (112 shown, 10 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 630 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ae47811`
...
- `test_apply_metadata_collects_nonfatal_ddl_warnings()` --calls--> `apply_metadata()`  [INFERRED]
  apps/backend/tests/test_source_seed_script_helpers.py → scripts/source_seed_metadata.py
...
Cohesion: 0.06
Nodes (46): ConfirmQuestionModal(), compactQuestions(), DEFAULT_SUGGESTED_QUESTIONS, normalizeSuggestedQuestionRecord(), normalizeSuggestedQuestions(), replaceSuggestedQuestionAt(), resolveSuggestedQuestions(), selectInitialSuggestedQuestions() (+38 more)
...
Cohesion: 0.05
Nodes (17): _cursor(), SelectAIBaseService, SelectAIScopedProfileMixin, _created_profile_attributes(), FakeLob, ScopedProfileConnection, ScopedProfileCursor, ScopedProfileService (+9 more)
...
Cohesion: 0.08
Nodes (16): _alter_if_missing(), _create_if_missing(), DashboardSchemaMixin, _normalize_visibility(), FakeLob, SchemaConnection, SchemaCursor, SchemaDbManager (+8 more)
...
Cohesion: 0.08
Nodes (24): DataSourceCatalogTableDetail, EMPTY_DATA_SOURCES, mergeMetadataWithColumns(), sortSchemaOptions(), DataSourceListHelpers, DataSourceListState, DataSourceStats, DataSourceSummary (+16 more)

### Community 15 - "Community 15"
Cohesion: 0.14
Nodes (21): _assert_conversation_writable(), _json_dump(), _materialize_stored_result(), _open_cursor(), _safe_max_rows(), SelectAIConversationMixin, SelectAIConversationMutationMixin, _transaction_cursor() (+13 more)

### Community 16 - "Community 16"
Cohesion: 0.1
Nodes (24): AnalyticsChatComposerProps, AnalyticsChatHeaderProps, AnalyticsChatMessageList(), AnalyticsSuggestedQuestionButtons(), AssistantChatListMessage, ChatListMessage, ChatMessageBubble(), formatTime() (+16 more)

### Community 17 - "Community 17"
Cohesion: 0.1
Nodes (23): ChartPreview(), DashboardItemMoveUpdate, DropPosition, getDashboardItemColumn(), getDashboardItemMoveUpdate(), getVisualizationWidth(), VisualizationWidth, Analytics() (+15 more)
...
Cohesion: 0.14
Nodes (18): _execute_metadata_statement(), _metadata_annotation_clause(), _metadata_by_column(), _primary_key_exists(), _replace_source_columns(), _assert_data_schema(), _grant_if_permitted(), _schema_name_exists_in_list() (+10 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (20): AssistantAnalyticsResult, AssistantChartSpec, AssistantResult(), DashboardDraftItem, DashboardModalDashboard, DashboardModalItem, DeleteDashboardModal(), DeleteVisualizationModal() (+12 more)
...
Cohesion: 0.11
Nodes (10): CatalogConnection, CatalogCursor, CatalogService, FakeLob, RegisterConnection, RegisterCursor, test_json_safe_reads_lobs_and_serializes_runtime_values(), test_list_data_sources_returns_json_safe_catalog_rows() (+2 more)
...
Cohesion: 0.1
Nodes (20): DataSourceObjectModal(), DataSourceObjectModalProps, csvField, csvFieldWrapper, metadataJsonField, metadataJsonFieldWrapper, ModalProps, onObjectModeChange (+12 more)
...
Cohesion: 0.17
Nodes (17): build_oci_client_config(), _failure_result(), _generative_model_options(), _inference_test_url(), missing_required_oci_config_keys(), _missing_saved_config_result(), _probe_inference_endpoint(), _read_key_file_content() (+9 more)
...
Cohesion: 0.13
Nodes (17): build_oracle_connection_kwargs(), open_runtime_database_connection(), parse_bootstrap_sql_statements(), read_private_key_for_db_credential(), resolve_runtime_database_config(), summarize_oracle_connect_error(), DbManager, Settings (+9 more)
...
Cohesion: 0.15
Nodes (7): RecordingConnection, RecordingCursor, RecordingDbManager, _source_column_inserts(), test_create_table_from_csv_accepts_and_records_column_metadata(), test_register_existing_table_accepts_and_records_column_metadata(), test_save_csv_upload_uses_configured_upload_directory()

### Community 42 - "Community 42"
Cohesion: 0.13
Nodes (14): SelectAIDataSourceCatalogMixin, _assert_catalog_table_selectable(), _select_catalog_columns(), _select_catalog_owners(), _select_catalog_table_comment(), _select_catalog_tables(), _select_data_sources(), SelectAIDataSourceMetadataMixin (+6 more)
...
Cohesion: 0.14
Nodes (14): SearchChatsModal(), analyticsApiMock, conversation, deleteOverlay, OpenSearchButton(), SearchChatsProbe(), searchOverlay, AnalyticsChatContext (+6 more)
...
Cohesion: 0.12
Nodes (8): _data_source_from_cursor(), SelectAIDataSourcePreviewMixin, _source_column_details(), SelectAIDataSourcePreviewMixin, PreviewConnection, PreviewCursor, PreviewService, test_preview_data_source_rows_serializes_rows_and_clamps_pagination()

### Community 48 - "Community 48"
Cohesion: 0.18
Nodes (14): _assert_csv_table_selectable(), _complete_load_job(), _create_csv_table(), CsvUploadRows, _drop_table_if_exists(), _insert_csv_rows(), _insert_load_job(), _mark_load_job_failed() (+6 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (16): ShowToast, AgentTraceItem, analyticsApi, AnalyticsAskRequest, AnalyticsAskResponse, AnalyticsConversationDetail, AnalyticsConversationMessage, AnalyticsConversationSummary (+8 more)
...
Cohesion: 0.16
Nodes (9): BootstrapOciMixin, _oci_file_values(), _upsert_config_items(), clear_status_cache(), normalize_oci_config_rows(), normalize_oci_config_value(), ReadableValue, test_normalize_oci_config_rows_strips_prefix_and_reads_values() (+1 more)

### Community 52 - "Community 52"
Cohesion: 0.13
Nodes (13): buildInstallErrorMessage(), InstallationData, InstallationResult, InstallationStep(), Props, SetupScriptError, renderStep(), SetupWizard() (+5 more)
...
Cohesion: 0.15
Nodes (15): AnalyticsVisualizationCard(), AnalyticsVisualizationCardProps, formatCellValue(), getInsertionLineClass(), getMetricLabel(), CardProps, item, onCardMouseDown (+7 more)
...
Cohesion: 0.23
Nodes (13): ConversationSummary, escapeRegExp(), highlightSearchMatch(), buildConversationMarkdown(), ConversationDetailForExport, ConversationMessageForExport, ConversationSummaryForSort, formatDateTime() (+5 more)

### Community 58 - "Community 58"
Cohesion: 0.12
Nodes (15): filterDataSources(), schemaNeedsCreation(), sortCatalogTables(), summarizeDataSources(), csvInput, csvReady, details, filtered (+7 more)

### Community 59 - "Community 59"
Cohesion: 0.23
Nodes (14): ColumnMetadataRequest, create_schema(), CreateSchemaRequest, delete_data_source(), describe_catalog_table(), ExistingTableRequest, list_catalog_owners(), list_catalog_tables() (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.25
Nodes (13): RuntimeError, _chunks(), _connect(), load_source_seed(), _load_table(), main(), assert_connected_schema(), drop_table_if_exists() (+5 more)

### Community 61 - "Community 61"
Cohesion: 0.22
Nodes (5): ConfigService, _is_missing_config_table_error(), _normalize_value(), Persist runtime configuration in the `config` table., from_runtime()
...
Cohesion: 0.21
Nodes (11): _runtime_db_config_path(), convert_csv_value(), _is_date_type(), _is_number_type(), _is_timestamp_type(), parse_datetime_value(), test_apply_metadata_collects_nonfatal_ddl_warnings(), test_convert_csv_value_rejects_bad_dates_and_numbers() (+3 more)
...
Cohesion: 0.24
Nodes (6): BootstrapDatabaseMixin, DatabaseBootstrapper, DbManager, test_list_wallet_dsns_reports_missing_tnsnames(), test_list_wallet_dsns_returns_aliases_and_prefers_medium(), test_save_runtime_db_config_delegates_to_db_manager()

### Community 72 - "Community 72"
Cohesion: 0.27
Nodes (10): _analytics_http_exception(), ask_analytics(), delete_analytics_conversation(), get_analytics_conversation(), get_question_recommendations(), list_analytics_conversations(), rename_analytics_conversation(), RenameAnalyticsConversationRequest (+2 more)
...
Cohesion: 0.29
Nodes (8): getLoginErrorMessage(), LoginForm(), makeMonochromeOracleSvg(), oracleServices, reviewSignals, login, AppBrand(), AppBrandProps
...
Cohesion: 0.47
Nodes (8): annotation_clause(), apply_metadata(), execute_metadata_statement(), metadata_by_column(), primary_key_exists(), safe_constraint_name(), sql_string_literal(), test_source_seed_metadata_helpers_normalize_sql_values()

### Community 86 - "Community 86"
Cohesion: 0.31
Nodes (7): replace_data_source(), column_type_label(), read_csv_rows(), table_columns(), ColumnMetadata, test_replace_data_source_registers_columns_with_metadata(), test_source_seed_table_io_reads_typed_csv_rows()
...
Cohesion: 0.32
Nodes (6): _select_user_question_usage(), _json_loads(), _json_safe(), _read_lob(), _rows_as_dicts(), test_question_usage_counts_only_successful_data_results()
...
Cohesion: 0.33
Nodes (5): AskAnalyticsRequest, SelectAIAnalyticsService, SelectAIAskMixin, SelectAIBaseService, SelectAIGenerationMixin
...
Cohesion: 0.6
Nodes (4): read_env_file_value(), runtime_connection_config(), runtime_db_config_path(), test_runtime_connection_config_requires_complete_json()
...
## Knowledge Gaps
- **449 isolated node(s):** `Top-level package marker for Docker runtime imports.`, `FastAPI entrypoint for Select AI Analytics.`, `Block runtime operations until the setup wizard has completed.`, `When `_env_file=None` is explicit, force defaults/init values only.`, `Persist DB connection chosen in setup wizard.` (+444 more)
...
- **Why does `DatabaseManager` connect `Community 31` to `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 25`, `Community 61`, `Community 62`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 7` to `Community 96`, `Community 42`, `Community 31`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `DashboardService` connect `Community 25` to `Community 38`, `Community 11`, `Community 79`, `Community 87`, `Community 27`, `Community 31`?**
