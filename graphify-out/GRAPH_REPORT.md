...
## Corpus Check
- 251 files · ~109,651 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2206 nodes · 3990 edges · 114 communities (104 shown, 10 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 610 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `780e7312`
...
Cohesion: 0.05
Nodes (32): BootstrapDatabaseMixin, BootstrapOciMixin, BootstrapScriptMixin, BootstrapStatusMixin, get_password_hash(), Generate bcrypt hash of password (72-byte limit)., BootstrapDatabaseMixin, create_admin_user() (+24 more)
...
Cohesion: 0.09
Nodes (15): SelectAIDataSourcePreviewMixin, SelectAIDataSourceMixin, CatalogConnection, CatalogCursor, CatalogService, MetadataCursor, RegisterConnection, RegisterCursor (+7 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (25): LoadingState(), LoadingStateProps, SIZE_STYLES, ConfirmDeleteModalProps, ConfirmModal(), ConfirmModalProps, ConfirmQuestionModal(), GlassModal() (+17 more)
...
Cohesion: 0.09
Nodes (24): DataSourceCatalogTableDetail, EMPTY_DATA_SOURCES, mergeMetadataWithColumns(), metadataWarningMessage(), summarizeDataSources(), DataSourceApiForMutations, DataSourceColumnMetadata, DataSourceMutationListState (+16 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (24): ShowToast, AnalyticsChatComposer(), AnalyticsChatComposerProps, AnalyticsChatHeader(), AnalyticsChatHeaderProps, AnalyticsChatMessageList(), AnalyticsSuggestedQuestionButtons(), AssistantChatListMessage (+16 more)
...
Cohesion: 0.1
Nodes (23): dataSourceStatusBadgeClassNames, filterDataSources(), metadataText(), ObjectSubmitState, PaginationWindow, parseCsvHeaderLine(), parseCsvHeaders(), parseMetadataJson() (+15 more)
...
Cohesion: 0.1
Nodes (9): FakeLob, SchemaConnection, SchemaCursor, SchemaDbManager, test_alter_if_missing_ignores_existing_column_or_constraint_errors(), test_create_if_missing_ignores_existing_object_error(), test_ensure_tables_creates_dashboard_schema_and_commits(), test_json_loads_reads_lobs_and_uses_default_for_null() (+1 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (12): SelectAIDataSourceMixin, SelectAIDataSourceCatalogMixin, SelectAIDataSourceCsvMixin, SelectAIDataSourceMetadataMixin, SelectAIDataSourcePreviewMixin, SelectAIDataSourceSchemaMixin, FakeLob, PreviewConnection (+4 more)
...
Cohesion: 0.12
Nodes (14): Footer(), SelectAIServicesStep(), apiKeySection, generativeSection, keyInput, objectStorageSection, onSetupComplete, renderStep() (+6 more)
...
Cohesion: 0.25
Nodes (13): _execute_metadata_statement(), _metadata_annotation_clause(), _metadata_by_column(), _primary_key_exists(), _replace_source_columns(), SelectAIDataSourceMetadataMixin, _clean_optional_text(), _qualified_name() (+5 more)
...
Cohesion: 0.18
Nodes (13): ToastProbe(), ToastContext, ToastContextType, ToastItem, ToastProvider(), ToastViewport(), useToast(), buildInstallErrorMessage() (+5 more)
...
## Knowledge Gaps
- **437 isolated node(s):** `Top-level package marker for Docker runtime imports.`, `FastAPI entrypoint for Select AI Analytics.`, `Block runtime operations until the setup wizard has completed.`, `When `_env_file=None` is explicit, force defaults/init values only.`, `Persist DB connection chosen in setup wizard.` (+432 more)
...
- **Why does `DatabaseManager` connect `Community 27` to `Community 66`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 82`, `Community 84`, `Community 61`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 82` to `Community 59`, `Community 91`, `Community 75`, `Community 52`, `Community 23`, `Community 27`, `Community 29`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `SelectAIDataSourceMixin` connect `Community 23` to `Community 34`, `Community 10`, `Community 45`, `Community 81`, `Community 82`, `Community 55`, `Community 29`?**
