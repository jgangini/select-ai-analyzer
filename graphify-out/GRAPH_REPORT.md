...
## Corpus Check
- 255 files · ~111,948 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2269 nodes · 4104 edges · 110 communities (100 shown, 10 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 617 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `483fbf06`
...
Cohesion: 0.06
Nodes (57): main(), build_create_table_sql(), _normalize_identifier(), oracle_type_for_ddl(), parse_source_tables(), Parse SQL*Plus DESC output from .source into table metadata.      Blocks with SQ, SourceColumn, SourceTable (+49 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (26): SelectAIDataSourceMixin, SelectAIDataSourceCatalogMixin, SelectAIDataSourceCsvMixin, SelectAIDataSourceMetadataMixin, SelectAIDataSourceMixin, SelectAIDataSourcePreviewMixin, SelectAIDataSourceSchemaMixin, CatalogConnection (+18 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (44): compactQuestions(), normalizeSuggestedQuestions(), parseCsvRows(), parseSuggestedQuestionsCsv(), replaceSuggestedQuestionAt(), selectInitialSuggestedQuestions(), STARTER_SUGGESTED_QUESTIONS, pool (+36 more)
...
Cohesion: 0.07
Nodes (29): ConfirmDeleteModal(), Profile(), ProfileFormData, currentUser, usersApiMock, emptyUserForm, UsersAuthUser, ChangePasswordPayload (+21 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (17): BootstrapStatusMixin, check_setup_status(), clear_status_cache(), Lightweight setup-status reader used by runtime guards., SetupStatusService, DbManager, FakeConnection, FakeCursor (+9 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (29): DashboardModalDashboard, DashboardModalItem, DeleteDashboardModal(), DeleteVisualizationModal(), RenameDashboardModal(), RenameVisualizationModal(), SqlModal(), onClose (+21 more)
...
Cohesion: 0.09
Nodes (23): ChartPreview(), AddDashboardStep, AnalyticsAddVisualizationModal(), AnalyticsDashboardTray(), AnalyticsDeleteChatModal(), DashboardChartSpec, DashboardDraftItem, DashboardSummary (+15 more)
...
Cohesion: 0.11
Nodes (16): DataDictionaryEditor(), DataSourceColumnMetadata, onColumnChange, DataSourceObjectModal(), DataSourceObjectModalProps, activeDraft, ModalProps, onObjectModeChange (+8 more)
...
Cohesion: 0.14
Nodes (14): SelectAIDataSourceCatalogMixin, _assert_catalog_table_selectable(), _select_catalog_columns(), _select_catalog_owners(), _select_catalog_table_comment(), _select_catalog_tables(), _select_data_sources(), _data_source_from_cursor() (+6 more)
...
Cohesion: 0.12
Nodes (4): CapacityExhaustedDuringNarrateAskService, CapacityExhaustedDuringSqlAskService, test_ask_propagates_capacity_error_during_narration_without_fallback_answer(), test_ask_propagates_capacity_error_during_sql_generation_without_fallback()
...
Cohesion: 0.33
Nodes (9): _analytics_http_exception(), ask_analytics(), AskAnalyticsRequest, delete_analytics_conversation(), get_analytics_conversation(), get_question_recommendations(), list_analytics_conversations(), rename_analytics_conversation() (+1 more)
...
- **Why does `DatabaseManager` connect `Community 31` to `Community 7`, `Community 8`, `Community 11`, `Community 13`, `Community 80`, `Community 25`, `Community 60`, `Community 61`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 80` to `Community 1`, `Community 4`, `Community 37`, `Community 75`, `Community 53`, `Community 31`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `SelectAIDataSourceMixin` connect `Community 4` to `Community 80`, `Community 1`, `Community 32`?**
