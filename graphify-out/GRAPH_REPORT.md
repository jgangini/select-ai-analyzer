...
Cohesion: 0.11
Nodes (22): DataSourceObjectModal(), DataSourceObjectModalProps, ModalProps, onObjectModeChange, catalogTablePlaceholder(), DataSourceCatalogOwner, DataSourceCatalogTable, DataSourceCatalogTableDetail (+14 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (23): AnalyticsChatComposerProps, AnalyticsChatHeaderProps, AnalyticsChatMessageList(), AssistantChatListMessage, ChatListMessage, ChatMessageBubble(), formatTime(), AnalyticsDashboardHeader() (+15 more)
...
Cohesion: 0.11
Nodes (20): metadataWarningMessage(), DataSourceApiForMutations, DataSourceColumnMetadata, DataSourceMutationListState, DataSourceMutations, DataSourceObjectFormForMutations, DataSourceSummary, showMetadataWarnings() (+12 more)
...
Cohesion: 0.18
Nodes (21): buildDropPosition(), buildEdgeDropPosition(), buildRowGapPosition(), DashboardItemMoveUpdate, DashboardLayoutItem, DropPositionInput, EMPTY_DROP_POSITION, findDashboardItemIndex() (+13 more)
...
Cohesion: 0.1
Nodes (20): ChartPreview(), AnalyticsAddVisualizationModal(), AnalyticsChatPanel(), ShowToast, AnalyticsChatComposer(), AnalyticsChatHeader(), AnalyticsSuggestedQuestionButtons(), composer (+12 more)
...
Cohesion: 0.13
Nodes (18): getDashboardItemColumn(), getDashboardItemMoveUpdate(), getVisualizationWidth(), container, createDashboardElement(), createGrid(), elementFromPointMock, first (+10 more)
...
Cohesion: 0.14
Nodes (16): ToastProbe(), ToastContext, ToastContextType, ToastItem, ToastProvider(), ToastViewport(), useToast(), InstallationStep() (+8 more)
...
Cohesion: 0.14
Nodes (11): Footer(), buildInstallErrorMessage(), InstallationData, InstallationResult, Props, SetupScriptError, SetupWizardData, SetupWizardProps (+3 more)
...
Cohesion: 0.15
Nodes (11): Header(), HeaderProps, LayoutProps, ActionMenuItem, ChatScrollbarState, formatRelativeUpdatedAt(), MenuItem, parseTimestamp() (+3 more)
...
Cohesion: 0.14
Nodes (12): AgentTraceItem, AnalyticsAskRequest, AnalyticsAskResponse, AnalyticsConversationDetail, AnalyticsConversationMessage, AnalyticsConversationSummary, analyticsQueryKeys, ChartSpec (+4 more)
...
Cohesion: 0.22
Nodes (7): ConfirmDeleteModalProps, ConfirmModal(), ConfirmModalProps, ConfirmQuestionModal(), GlassModal(), GlassModalProps, ModalPortalProps
...
- **Why does `DatabaseManager` connect `Community 27` to `Community 65`, `Community 3`, `Community 6`, `Community 9`, `Community 11`, `Community 80`, `Community 81`, `Community 61`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 80` to `Community 2`, `Community 75`, `Community 12`, `Community 50`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `SelectAIDataSourceMixin` connect `Community 2` to `Community 39`, `Community 40`, `Community 12`, `Community 80`, `Community 82`, `Community 58`?**
