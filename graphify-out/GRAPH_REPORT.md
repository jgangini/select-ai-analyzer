...
## Corpus Check
- 252 files · ~110,025 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2211 nodes · 3998 edges · 115 communities (103 shown, 12 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 610 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `136622d3`
...
Cohesion: 0.05
Nodes (58): AddVisualizationButton(), ChartControls(), ChartControlsProps, ChartScrollbarState, ChartScrollFrame(), ChartSortMode, chartRendererTools, ResultTableRenderer (+50 more)
...
Cohesion: 0.05
Nodes (37): BootstrapDatabaseMixin, BootstrapOciMixin, BootstrapScriptMixin, create_access_token(), decode_access_token(), get_current_user(), get_password_hash(), get_settings() (+29 more)
...
Cohesion: 0.08
Nodes (15): Block runtime operations until the setup wizard has completed., require_setup_completed(), get_db_manager(), Helpers de sesion/conexion para FastAPI., Retorna singleton de DatabaseManager., ConfigService, _is_missing_config_table_error(), _normalize_value() (+7 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (13): _alter_if_missing(), _create_if_missing(), DashboardSchemaMixin, FakeLob, SchemaConnection, SchemaCursor, SchemaDbManager, test_alter_if_missing_ignores_existing_column_or_constraint_errors() (+5 more)
...
Cohesion: 0.08
Nodes (25): ChartPreview(), AddDashboardStep, AnalyticsAddVisualizationModal(), AnalyticsDashboardTray(), AnalyticsDeleteChatModal(), DashboardChartSpec, DashboardDraftItem, DashboardSummary (+17 more)
...
Cohesion: 0.11
Nodes (11): SelectAIDataSourcePreviewMixin, CatalogConnection, CatalogCursor, CatalogService, FakeLob, RegisterConnection, RegisterCursor, test_json_safe_reads_lobs_and_serializes_runtime_values() (+3 more)
...
Cohesion: 0.11
Nodes (22): AnalyticsChatComposerProps, AnalyticsChatHeaderProps, AssistantChatListMessage, ChatListMessage, ChatMessageBubble(), formatTime(), AnalyticsDashboardHeader(), AnalyticsDashboardTabs() (+14 more)
...
Cohesion: 0.12
Nodes (7): _created_profile_attributes(), FakeLob, ScopedProfileConnection, ScopedProfileCursor, ScopedProfileService, test_create_scoped_profile_rejects_missing_genai_model(), test_create_scoped_profile_uses_configured_genai_model()
...
Cohesion: 0.17
Nodes (15): compactQuestions(), DEFAULT_SUGGESTED_QUESTIONS, normalizeSuggestedQuestionRecord(), replaceSuggestedQuestionAt(), resolveSuggestedQuestions(), selectRandomSuggestedQuestions(), SUGGESTED_QUESTION_KEYS, fieldValue() (+7 more)
...
Cohesion: 0.15
Nodes (16): build_oci_client_config(), missing_required_oci_config_keys(), parse_tns_aliases(), resolve_backend_root(), resolve_bootstrap_sql_dir(), resolve_oci_cli_config_path(), resolve_oci_key_file_path(), select_preferred_wallet_dsn() (+8 more)
...
Cohesion: 0.15
Nodes (5): Raised when the configured model provider reports temporary capacity exhaustion., SelectAIModelCapacityError, SelectAIGenerationMixin, SelectAIAskMixin, CapacityFallbackAskService
...
Cohesion: 0.26
Nodes (8): BootstrapOciMixin, _failure_result(), _generative_model_options(), _inference_test_url(), _missing_saved_config_result(), _probe_inference_endpoint(), _read_key_file_content(), _success_result()
...
Cohesion: 0.33
Nodes (5): SelectAIAnalyticsService, SelectAIBaseService, SelectAIConversationMixin, SelectAIGenerationMixin, SelectAIScopedProfileMixin
...
## Knowledge Gaps
- **438 isolated node(s):** `Top-level package marker for Docker runtime imports.`, `FastAPI entrypoint for Select AI Analytics.`, `Block runtime operations until the setup wizard has completed.`, `When `_env_file=None` is explicit, force defaults/init values only.`, `Persist DB connection chosen in setup wizard.` (+433 more)
...
- **Why does `DatabaseManager` connect `Community 55` to `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 83`, `Community 23`, `Community 90`, `Community 62`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `SelectAIBaseService` connect `Community 83` to `Community 36`, `Community 93`, `Community 55`, `Community 59`, `Community 92`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `SelectAIDataSourceMixin` connect `Community 36` to `Community 69`, `Community 38`, `Community 44`, `Community 49`, `Community 17`, `Community 83`, `Community 87`, `Community 29`?**
