...
## Corpus Check
- 258 files · ~113,655 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2319 nodes · 4179 edges · 115 communities (105 shown, 10 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 625 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `986c182d`
...
Cohesion: 0.05
Nodes (55): ColumnMetadataRequest, create_schema(), CreateSchemaRequest, delete_data_source(), describe_catalog_table(), ExistingTableRequest, list_catalog_owners(), list_catalog_tables() (+47 more)
...
Cohesion: 0.05
Nodes (33): create_access_token(), decode_access_token(), get_current_user(), get_settings(), Inject settings from main.py., Verify password against bcrypt hash., Dependency to get current user from JWT token., set_settings() (+25 more)
...
Cohesion: 0.07
Nodes (37): DashboardItemMutationMixin, _dashboard_item_insert_params(), _dashboard_item_update_fields(), _json_object_literal(), _normalize_dashboard_item_ids(), _normalize_dashboard_items(), _normalize_required_text(), _dashboard_exists_for_owner() (+29 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (24): Block runtime operations until the setup wizard has completed., require_setup_completed(), get_db_manager(), Helpers de sesion/conexion para FastAPI., Retorna singleton de DatabaseManager., id, BootstrapStatusMixin, check_setup_status() (+16 more)
...
Cohesion: 0.07
Nodes (34): DataSourceCatalogOwner, DataSourceCatalogTable, DataSourceCatalogTableDetail, DataSourceSchema, dataSourceStatusBadgeClassNames, EMPTY_DATA_SOURCES, filterDataSources(), mergeMetadataWithColumns() (+26 more)
...
Cohesion: 0.07
Nodes (29): DataSourcePreviewModal(), DataSourcePreviewModalProps, onClose, onPageChange, PreviewProps, { rerender }, response, source (+21 more)
...
Cohesion: 0.09
Nodes (24): ChartPreview(), AddDashboardStep, AnalyticsAddVisualizationModal(), AnalyticsDashboardTray(), AnalyticsDeleteChatModal(), DashboardChartSpec, DashboardDraftItem, DashboardSummary (+16 more)
...
Cohesion: 0.11
Nodes (18): missing_required_oci_config_keys(), normalize_oci_config_rows(), parse_bootstrap_sql_statements(), parse_tns_aliases(), select_preferred_wallet_dsn(), DbManager, ReadableValue, Settings (+10 more)
...
Cohesion: 0.12
Nodes (15): DataDictionaryEditor(), DataSourceColumnMetadata, onColumnChange, DataSourceObjectModal(), DataSourceObjectModalProps, DataSourceSchemaCreationConfirmModal(), activeDraft, heading (+7 more)
...
Cohesion: 0.19
Nodes (20): _capture_runtime_config(), clean_schema(), _drop_current_schema_objects(), _drop_data_schema(), _drop_retired_select_ai_artifacts(), _drop_select_ai_profiles(), _env_runtime_config(), _existing_profiles() (+12 more)

### Community 36 - "Community 36"
Cohesion: 0.13
Nodes (10): _alter_if_missing(), _create_if_missing(), DashboardSchemaMixin, FakeLob, SchemaCursor, test_alter_if_missing_ignores_existing_column_or_constraint_errors(), test_create_if_missing_ignores_existing_object_error(), test_json_loads_reads_lobs_and_uses_default_for_null() (+2 more)
...
Cohesion: 0.11
Nodes (18): AnalyticsChatComposer(), AnalyticsChatComposerProps, AnalyticsChatHeader(), AnalyticsChatHeaderProps, AnalyticsSuggestedQuestionButtons(), AssistantChatListMessage, ChatListMessage, ChatMessageBubble() (+10 more)
...
Cohesion: 0.11
Nodes (9): DashboardItemMutationMixin, DashboardMutationMixin, DashboardQueryMixin, DashboardSchemaMixin, DashboardItemsCreateRequest, DashboardService, SchemaConnection, SchemaDbManager (+1 more)
...
Cohesion: 0.14
Nodes (6): FakeLob, PreviewConnection, PreviewCursor, test_json_safe_reads_lobs_and_serializes_runtime_values(), test_preview_data_source_rows_serializes_rows_and_clamps_pagination(), test_sql_name_helpers_reject_blank_identifier()
...
Cohesion: 0.13
Nodes (15): DataSourceColumnMetadata, metadataWarningMessage(), cloneCsvUploadDrafts(), CsvUploadMutationVariables, CsvUploadStarter, DataSourceApiForMutations, DataSourceColumnMetadata, DataSourceMutationListState (+7 more)
...
Cohesion: 0.18
Nodes (15): build_oracle_connection_kwargs(), _generative_model_options(), _inference_test_url(), open_runtime_database_connection(), _probe_inference_endpoint(), resolve_backend_root(), resolve_bootstrap_sql_dir(), resolve_oci_cli_config_path() (+7 more)
...
Cohesion: 0.14
Nodes (11): DataSourceDeleteConfirmModal(), DataSourceStats, formatNumber(), useDataSourceMutations(), buildDataSourcesController(), useDataSourceQueries(), useDataSourcesController(), DataSources() (+3 more)
...
Cohesion: 0.29
Nodes (7): BootstrapOciMixin, build_oci_client_config(), _failure_result(), _missing_saved_config_result(), _read_key_file_content(), _success_result(), test_build_oci_client_config_uses_api_signing_fields()
...
Cohesion: 0.18
Nodes (9): BootstrapDatabaseMixin, BootstrapScriptMixin, BootstrapStatusMixin, get_password_hash(), Generate bcrypt hash of password (72-byte limit)., RuntimeError, create_admin_user(), Initial setup service (database, OCI, admin user). (+1 more)
...
Cohesion: 0.2
Nodes (3): CapacityExhaustedDuringNarrateAskService, test_ask_propagates_capacity_error_during_narration_without_fallback_answer(), test_ask_propagates_capacity_error_during_sql_generation_without_fallback()

### Community 77 - "Community 77"
Cohesion: 0.22
Nodes (6): _oci_file_values(), _upsert_config_items(), normalize_oci_config_value(), read_private_key_for_db_credential(), test_read_private_key_for_db_credential_rejects_empty_key(), test_read_private_key_for_db_credential_strips_pem_markers()
...
Cohesion: 0.25
Nodes (3): RegisterConnection, RegisterCursor, test_register_existing_table_rolls_back_when_source_column_sync_fails()
...
Cohesion: 0.38
Nodes (4): Footer(), Header(), HeaderProps, LayoutProps
...
- **Why does `id` connect `Community 10` to `Community 97`, `Community 3`?**
  _High betweenness centrality (0.438) - this node is a cross-community bridge._
- **Why does `DatabaseManager` connect `Community 65` to `Community 3`, `Community 7`, `Community 8`, `Community 42`, `Community 10`, `Community 13`, `Community 80`, `Community 56`, `Community 89`?**
  _High betweenness centrality (0.326) - this node is a cross-community bridge._
- **Why does `BootstrapStatusMixin` connect `Community 10` to `Community 65`, `Community 67`?**
